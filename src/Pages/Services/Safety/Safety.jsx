            ...
            <Container>
                <Row>
                    <Col md={12} lg={8} lg={{ order: 2 }} className="text-center">
                        ...
                        <p className="w-50 m-auto content-inner">Since 1998, Dr Vandna has been proud to combine modern techniques and high-tech equipment. Dr. John Dae, Micha and his team deliver a personalized and comfortable Homeopathy care experience unlike any other Mason Dentist.</p>
                    </Col>
                </Row>
                <Row>
                    <Col md={6} lg={6}>
